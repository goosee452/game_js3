class Room {
    ...
    serialise_alt() {
        ...
        let room = {
            ...
            door_pos: {
                x: this.door.location.x,
                y: this.door.location.y
            },
            background_src: this.background.src,
            width: this.#width,
            height: this.#height,
    ...
    deserialise_alt(src) {
        ...
        function setObject(object) {
            ...
            else if (object.type == 'spikes5_down') {
                newObject = setSpikeDown(object.location_x, object.location_y);
            }
            else if (object.type == 'spikes5_right') {
                newObject = setSpikeRight(object.location_x, object.location_y);
            }
            else if (object.type == 'spikes5_left') {
                newObject = setSpikeLetf(object.location_x, object.location_y);
            }
            else if (object.type == 'platform_large') {
                newObject = setPlatformLarge(object.location_x, object.location_y);
            }
            else if (object.type == 'platform_larger') {
                newObject = setPlatformLarger(object.location_x, object.location_y);
            }
            else if (object.type == 'platform_medium') {
                newObject = setPlatformMedium(object.location_x, object.location_y);
            }
            else if (object.type == 'dash_crystal') {
                newObject = setDashCrystal(object.location_x, object.location_y);
            }
            else if (object.type == 'platform_crystal') {
                newObject = setPlatformCrystal(object.location_x, object.location_y);
            }
            else if (object.type == 'hyperjump_crystal') {
                newObject = setHyperjumpCrystal(object.location_x, object.location_y);
            }
            else if (object.type == 'teleport_crystal') {
                newObject = setTeleportCrystal(object.location_x, object.location_y);
            }
        ...
        this.door = setDoor(room.door_pos.x, room.door_pos.y);
        this.#spikes = new Array(room.spikes.length);
        for (let i = 0; i < this.#spikes.length; i++) {
